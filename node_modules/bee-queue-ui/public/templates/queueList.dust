            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        data-bind="attr: { "aria-labelledby": 'queue_dropdown_' + $index() }">
                        <li><a href="#" data-bind="click: function(data, event) { redisHandler.fn.deleteByStatus('waiting', data) }">Delete All Waiting</a></li>
                        <li><a href="#" data-bind="click: function(data, event) { redisHandler.fn.deleteByStatus('active', data) }">Delete All Active</a></li>
                        <li><a href="#" data-bind="click: function(data, event) { redisHandler.fn.deleteByStatus('succeded', data) }">Delete All Succeded</a></li>
