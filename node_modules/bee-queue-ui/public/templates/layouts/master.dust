...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Bee-Queue-UI</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li {?complete}class="active"{/complete}><a href="{basepath}/complete">Succeeded<span data-bind="visible: complete() != null, text: complete"></span></a></li>
                ...
                <li {?pending}class="active"{/pending}><a href="{basepath}/pending">Waiting<span data-bind="visible: pending() != null, text: pending"></span></a></li>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li><h3>Bee-Queue-UI</h3></li>
                <li {?overview}class="active"{/overview}><a href="{basepath}/">Overview</a></li>
                <li {?complete}class="active"{/complete}><a href="{basepath}/complete">Succeeded<span data-bind="visible: complete() != null, text: complete"></span></a></li>
                <li {?failed}class="active"{/failed}><a href="{basepath}/failed">Failed<span data-bind="visible: failed() != null, text: failed"></span></a></li>
                <li {?active}class="active"{/active}><a href="{basepath}/active">Active<span data-bind="visible: active() != null, text: active"></span></a></li>
                <li {?pending}class="active"{/pending}><a href="{basepath}/pending">Waiting<span data-bind="visible: pending() != null, text: pending"></span></a></li>
...
<script type="text/javascript">
    var keys = [];
    {#keys}
    keys.push({id: "{id}", type: "{type}", status: "{status}"{?progress}, progress: "{progress}"{/progress}});
    {/keys}
