var RedisHandler = function(){
    ...
    _self.fn = {
        ...
        pendingById: function(o){
            var id = o.id;
            var type = o.type;
            _self.util.notyConfirm("Are you sure you want make the job of type "+ type + " with ID #"+id+" waiting? This will put this job in the queue to be run again.", function(){
                _self.util.blockUI();
        ...
        pendingByStatus: function(status) {
            ...
            _self.util.notyConfirm("Are you sure you want to make <strong>all</strong> jobs with the status " + status + " waiting? This will put all jobs with this status in the queue to be run again.", function () {
                _self.util.blockUI();
